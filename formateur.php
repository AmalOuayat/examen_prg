...
<head>
    ...
    <title>ExamPro - Interface Formateur</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            /* Palette de couleurs de admin.php */
            ...
            /* Variables additionnelles dérivées de la palette */
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-content">
                <div class="nav-section">
                    <ul class="nav-links">
                        <li class="nav-item">
                            <a href="formateur_dashboard.php" target="content-frame" class="nav-link active">
                ...
                <div class="nav-section">
                    ...
                    <ul class="nav-links">
                        <li class="nav-item">
                            <a href="creerExamen22.php" target="content-frame" class="nav-link">
                                <i class="fas fa-file-alt nav-link-icon"></i>
                                <span>Créer Examen</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="corriger_examen.php" target="content-frame" class="nav-link">
                                <i class="fas fa-check-circle nav-link-icon"></i>
                                <span>Corriger Examen</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="voir_resultats_formateur.php" target="content-frame" class="nav-link">
                                <i class="fas fa-chart-bar nav-link-icon"></i>
                                <span>Voir les résultats</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="liste_etudiants.php" target="content-frame" class="nav-link">
                                <i class="fas fa-chart-bar nav-link-icon"></i>
                                <span>la liste des etudiants</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="mes_examens.php" target="content-frame" class="nav-link">
                                <i class="fas fa-chart-bar nav-link-icon"></i>
            ...
            <div class="sidebar-footer">
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        <div class="user-name">Formateur</div>
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="content-area">
                <div class="iframe-container">
                    <iframe src="formateur_dashboard.php" name="content-frame" id="content-frame" frameborder="0"
