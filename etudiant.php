...
<head>
    ...
    <title>ExamPro - Interface Étudiant</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            /* Palette de couleurs de formateur.php */
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <div class="sidebar-header">
                <a href="#" class="logo">
                    ...
                    <span class="etudiant-badge">Étudiant</span>
                </a>
            </div>
            ...
            <div class="sidebar-content">
                <div class="nav-section">
                    <ul class="nav-links">
                        <li class="nav-item">
                            <a href="etudiant_dashboard.php" target="content-frame" class="nav-link active">
                ...
                <div class="nav-section">
                    <h5 class="nav-section-title">Examens</h5>
                    <ul class="nav-links">
                        <li class="nav-item">
                            <a href="passerExamen2.php" target="content-frame" class="nav-link">
                                <i class="fas fa-file-alt nav-link-icon"></i>
                                <span>Passer un examen</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="voir_resultats_etudiant.php" target="content-frame" class="nav-link">
            ...
            <div class="sidebar-footer">
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        <div class="user-name">Étudiant</div>
                        <div class="user-role">Apprenant</div>
                    </div>
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="content-area">
                <div class="iframe-container">
                    <iframe src="etudiant_dashboard.php" name="content-frame" id="content-frame" frameborder="0"
